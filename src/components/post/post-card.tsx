...
const PostCard = ({
  ...
  return (
    <div className="relative my-5 w-full flex-1 p-4 px-3">
      {/* Random organic glow effect */}
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-transparent to-blue-500/10 blur-3xl"></div>
      <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/10 via-transparent to-orange-500/10 blur-3xl"></div>
      <div className="absolute -inset-4 bg-gradient-to-br from-orange-500/5 via-transparent to-blue-500/5 blur-2xl"></div>
      <div className="absolute -inset-4 bg-gradient-to-tr from-blue-500/5 via-transparent to-orange-500/5 blur-2xl"></div>
